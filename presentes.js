$(".choice").on("click", function () {
  ...
  $(".copyButton").on("click", function () {
    let chavePix = `00020101021126460014br.gov.bcb.pix01110770244190902095204000053039865406${value.text()}3.005802BR5917IGOR FRANK MORENO6008SAO JOSE62070503***6304A2A8`;
